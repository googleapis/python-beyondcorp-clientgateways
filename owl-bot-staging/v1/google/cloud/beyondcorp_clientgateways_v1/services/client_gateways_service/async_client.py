...
class ClientGatewaysServiceAsyncClient:
    """API Overview:
    ...
    DEFAULT_ENDPOINT = ClientGatewaysServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = ClientGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT

    client_gateway_path = staticmethod(ClientGatewaysServiceClient.client_gateway_path)
    parse_client_gateway_path = staticmethod(ClientGatewaysServiceClient.parse_client_gateway_path)
    common_billing_account_path = staticmethod(ClientGatewaysServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ClientGatewaysServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ClientGatewaysServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ClientGatewaysServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ClientGatewaysServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ClientGatewaysServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ClientGatewaysServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ClientGatewaysServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ClientGatewaysServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ClientGatewaysServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ClientGatewaysServiceAsyncClient: The constructed client.
        """
        return ClientGatewaysServiceClient.from_service_account_info.__func__(ClientGatewaysServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ClientGatewaysServiceAsyncClient: The constructed client.
        """
        return ClientGatewaysServiceClient.from_service_account_file.__func__(ClientGatewaysServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return ClientGatewaysServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> ClientGatewaysServiceTransport:
        ...
        Returns:
            ClientGatewaysServiceTransport: The transport used by the client instance.
        """
        return self._client.transport

    get_transport_class = functools.partial(type(ClientGatewaysServiceClient).get_transport_class, type(ClientGatewaysServiceClient))
    ...
    def __init__(self, *,
        ...
        """
        self._client = ClientGatewaysServiceClient(
    ...
    async def list_client_gateways(self,
        ...
        response = pagers.ListClientGatewaysAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_client_gateway(self,
    ...
    async def create_client_gateway(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_client_gateway():
                # Create a client
                client = beyondcorp_clientgateways_v1.ClientGatewaysServiceAsyncClient()
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            client_gateway (:class:`google.cloud.beyondcorp_clientgateways_v1.types.ClientGateway`):
    ...
    async def delete_client_gateway(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_client_gateway():
                # Create a client
                client = beyondcorp_clientgateways_v1.ClientGatewaysServiceAsyncClient()
