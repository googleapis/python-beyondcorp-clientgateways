...
class ClientGatewaysServiceClient(metaclass=ClientGatewaysServiceClientMeta):
    ...
    @staticmethod
    def client_gateway_path(project: str,location: str,client_gateway: str,) -> str:
        """Returns a fully-qualified client_gateway string."""
        return "projects/{project}/locations/{location}/clientGateways/{client_gateway}".format(project=project, location=location, client_gateway=client_gateway, )
    ...
    def create_client_gateway(self,
    ...
    def delete_client_gateway(self,
