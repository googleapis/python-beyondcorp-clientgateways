...
class ClientGatewaysServiceAsyncClient:
    ...
    parse_client_gateway_path = staticmethod(
        ClientGatewaysServiceClient.parse_client_gateway_path
    )
    common_billing_account_path = staticmethod(
        ClientGatewaysServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        ClientGatewaysServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(ClientGatewaysServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        ClientGatewaysServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        ClientGatewaysServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        ClientGatewaysServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(ClientGatewaysServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        ClientGatewaysServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        ClientGatewaysServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        ClientGatewaysServiceClient.parse_common_location_path
    )
    ...
    get_transport_class = functools.partial(
        type(ClientGatewaysServiceClient).get_transport_class,
